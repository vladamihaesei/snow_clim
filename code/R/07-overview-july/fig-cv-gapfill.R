...
read_docx() %>% 
  ...
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/OVERVIEW/03_july_meeting/table_cv_overview.docx")
...
gg1 <- dat_plot %>% 
  melt(measure.vars = c("mae", "mae_nozero")) %>% 
...
ggsave(gg_all,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/OVERVIEW/03_july_meeting/fig/cv-gapfill-mae.png", 
       width = 12, height = 6)
