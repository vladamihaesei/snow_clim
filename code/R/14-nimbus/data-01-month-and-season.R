...
saveRDS(dat_hs_full2, "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-01-monthly.rds")
...
dat_hs2 <- dat_hs[year >= 1981 & year <= 2010 & month %in% month_sub & !is.na(HS)]
dat_hs2[, nn_year := .N, .(Name, month)]
dat_hs_full <- dat_hs2[nn_year == max(nn_year)]
...
saveRDS(dat_hs_full2, "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-04-monthly-1981-2010.rds")
...
saveRDS(dat_ind_long2_full, "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-02-seasonal.rds")
...
dat_ind_long2 <- dat_ind_long[year >= 1981 & year <= 2010 & !is.na(value)]
dat_ind_long2[, nn_year := .N, .(Name, variable)]
dat_ind_long2_full <- dat_ind_long2[nn_year == max(nn_year)]

saveRDS(dat_ind_long2_full, "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-05-seasonal-1981-2010.rds")
