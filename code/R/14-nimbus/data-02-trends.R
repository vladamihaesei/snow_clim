...
dat_month <- readRDS("/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-01-monthly.rds")
dat_seasonal <- readRDS("/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/data-02-seasonal.rds")
...
save(dat_month_ols, dat_month_gls, dat_seasonal_ols, dat_seasonal_gls,
     file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/NIMBUS/rds/trends-01-1971-2019-ols-gls.rda")
