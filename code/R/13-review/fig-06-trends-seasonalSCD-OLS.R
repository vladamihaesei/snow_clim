...
dat_plot_full <- dat_seasonal_ols[term == "year0" & startsWith(variable, "SCD")] %>% 
  merge(dat_meta_clust, by = "Name")
...
ggsave(gg,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/fig/zenodo-SM/trends-seasonalSCD-OLS.png",
       width = 10,
       height = 11)
...
read_docx() %>% 
  ...
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/table/supplement/trends-ols-seasonalSCD-500m.docx")
...
read_docx() %>% 
  body_add_flextable(ft) %>% 
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/table/supplement/trends-ols-seasonalSCD-1000m.docx")
