...
dat_plot_full <- dat_month_ols[term == "year0"] %>% 
...
ggsave(gg,
       filename = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/fig/zenodo-SM/trends-month-ols.png",
       width = 10,
       height = 11)
...
read_docx() %>% 
  ...
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/table/supplement/trends-ols-month-500m.docx")
...
read_docx() %>% 
  body_add_flextable(ft) %>% 
  print(target = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/PAPER/02_review/table/supplement/trends-ols-month-1000m.docx")
