...
cv_fun <- function(cv_min_corr = 0.7,
                   cv_max_dist_horiz_km = 200,
                   cv_max_dist_vert_m = 500,
                   cv_sort_by = "corr",
                   cv_weight_by = "dist_v",
                   cv_n_ref_max = 5,
                   cv_file){
  ...
  # test sub
  # test_sub_stn <- sample(1:nrow(dat_meta_1), 14)
    ...
    dat_out_stn <- foreach(
      ...
      dat_out_month <- foreach(
        ...
        l_fill <- fill_daily_meteo_gaps(df_meta = meta_i,
                                        ...
                                        stns_to_fill = ii_stn,
                                        rows_to_fill = i_gap,
                                        min_corr = cv_min_corr,
                                        max_dist_horiz_km = cv_max_dist_horiz_km,
                                        max_dist_vert_m = cv_max_dist_vert_m,
                                        elev_threshold = NULL,
                                        digits_round = 0,
                                        ratio_var = T,
                                        sort_by = cv_sort_by,
                                        weight_by = cv_weight_by,
                                        n_ref_max = cv_n_ref_max,
                                        verbose = 0,
...
try(cv_fun(cv_min_corr = 0.8,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/01_min_corr_08.rds"))

try(cv_fun(cv_min_corr = 0.9,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/02_min_corr_09.rds"))

try(cv_fun(cv_max_dist_horiz_km = 100,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/03_max_dist_h_100.rds"))

try(cv_fun(cv_max_dist_vert_m = 250,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/04_max_dist_v_250.rds"))

try(cv_fun(cv_max_dist_horiz_km = 100, cv_max_dist_vert_m = 250,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/05_max_dist_h_100_max_dist_v_250.rds"))

try(cv_fun(cv_sort_by = "dist_v",
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/06_sort_by.rds"))

try(cv_fun(cv_weight_by = "corr",
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/07_weight_by.rds"))

try(cv_fun(cv_sort_by = "dist_v", cv_weight_by = "corr",
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/08_sort_by_weight_by.rds"))

try(cv_fun(cv_n_ref_max = 3,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/09_n_ref_3.rds"))

try(cv_fun(cv_n_ref_max = 1,
           cv_file = "/mnt/CEPH_PROJECTS/ALPINE_WIDE_SNOW/04_GAPFILL/rds/cv-test-param/10_n_ref_1.rds"))
