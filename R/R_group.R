...
t1 <- read.csv(paste0(drive_z, "tab_export/trend_GROSZ_prima_ultima_1961-2019.csv"))
...
write_sf(t1.sf,paste0(drive_z,"shp/trends_prima_ultima_koeppen.shp"))

tt <- as.data.frame(t1.sf)

tt <- tt%>%mutate(Alt = case_when(Z <= 200~ "≤ 200 m",
