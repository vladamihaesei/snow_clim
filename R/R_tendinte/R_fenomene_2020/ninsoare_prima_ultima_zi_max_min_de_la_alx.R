...
t1 <- read.csv("tab/ZAPADA_1961_2019.csv")
numeorig <- names(t1)[3]
...
t1$ZAPADA[is.na(t1$NETB)] <- NA # asta trebuie corectata
...
dww
#write.csv(dww,  paste0("tabs/prima_ultima_zi_fen_GROSZ_total",".csv"), row.names=F)
