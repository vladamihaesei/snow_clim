...
png(paste0(drive_z,"png/frecventa_decadal_prima_zi_ninsoare_1961_2020.png"), width = 2000, height = 1600, res = 200)
p
dev.off()
...
png(paste0(drive_z,"png/frecventa_decadal_ultima_zi_ninsoare_1961_2020.png"), width = 2000, height = 1600, res = 200)
u
dev.off()
