...
end <- c(1970,1980,1990,2000,2010,2020)
...
t1 <- t1 %>% filter(COD!= 428307 ) ### elimina Bacles
t1 <- na.omit(t1)
summary(t1)
...
vef <- read.csv("~/D/2021/Date_doctorat/Zapada_doctorat/tab_export/decadal/prima_ultima_zi_fen_GROSZ_1971_1980_zile_juliene.csv")
