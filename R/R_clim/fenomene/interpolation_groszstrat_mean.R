...
for( i in 1:length(tabs)){
  ...
  writeRaster(tt_reg_prj,paste0(drive_z,"grids_export/decadal/prima_zi_medie_strat_cu_zapada_",per1,".tif"))
  ...
  writeRaster(tt_reg_prj,paste0(drive_z,"grids_export/decadal/ultima_zi_medie_strat_cu_zapada_",per1,".tif"))
